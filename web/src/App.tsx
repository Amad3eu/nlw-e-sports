  ...
  return(
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <h1 className="text-7xl text-white font-black mt-20" >
        Seu 
        <span className="text-transparent bg-nwl-gradient bg-clip-text"> duo </span>
        está aqui
      </h1>
    ...
    <div className="grid grid-cols-6 gap-6 mt-16 ">
        ...
        <a href="" className="relative">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="font-bold text-white block">Countr Strike</strong>
            <span className="text-zinc-300 text-sm block mt-1">Anuncios</span>
          </div>
        </a>
        ...
        <a href="" className="relative">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="font-bold text-white block">Fotrtnite</strong>
            <span className="text-zinc-300 text-sm block mt-1">Anuncios</span>
          </div>
        </a>
